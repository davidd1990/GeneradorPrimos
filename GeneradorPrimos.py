...
def main():
    ...
    t1 = threading.Thread(target=encontrar_primos_threads, args=(500000, 8,))
    t2 = threading.Thread(target=encontrar_primos_threads, args=(1000000, 500000,))
    t3 = threading.Thread(target=encontrar_primos_threads, args=(1500000, 1000000,))
    t4 = threading.Thread(target=encontrar_primos_threads, args=(2000000, 1500000,))
    ...
    p.sort()
    print(p)
    print("trabajo terminao con threads : ", time.time()-t)

    #Aqui empieza el metodo normal sin ningun Thread
    t = time.time()
    encontrarprimos(2000000)
    print("trabajo terminao sin threads en : ", time.time()-t)
